...
class Moderation(commands.Cog, name="moderation"):
    ...
    @checks.not_blacklisted()
    @app_commands.describe(user="The user that should be banned.", reason="The reason why the user should be banned.")
    async def bann(self, context: Context, user: discord.User, reason: str = "Not specified") -> None:
        """
    ...
    async def unban(self, ctx, user_id:str) :
        ...
        embed = discord.Embed(description="✅  "+f"Successfully unbanned **{user}**.", color=0xDA004E) 
    ...
    @commands.hybrid_command(
      name = "changeprefix", 
      description = "Change this bot  prefix for this server"
    )
    @commands.has_permissions(administrator = True)
    async def changeprefix(self,context:Context, prefix):
